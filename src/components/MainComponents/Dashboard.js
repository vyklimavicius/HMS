        ...
        return (
            ...
            {/* <div> */}
                <Grid item xs={1} sm={1} style={{position: 'fixed'}}>
                    <Paper style={{ border: '1px solid #16162D', boxShadow: '10px 10px #16162D', backgroundColor: 'rgba(192,192,192,0.5)', padding: 5, marginTop: 10, marginBottom: 10, height: 720, width:100}}>
                 <UserDetails user={props.currentUser} />
                </Paper>
                </Grid>
                <Grid item sm>
                    <Paper style={{ border: '1px solid black', boxShadow: '10px 10px #16162D', padding: 10, marginTop: 20, marginLeft: 130, marginBottom: 10, height: 400, width:1200 }}>
                <TaskBar />
                </Paper>
                </Grid>
                <Grid item sm>
